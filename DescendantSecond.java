...
public class DescendantSecond implements IDescendantMethods{
    ...
    public int roomId;
    public double fitnessFuntionValue=-1;
    ...
    public double CalculateFitnessFunction()
    {
        ...
        fitnessFuntionValue = (profit - loss)*(1 - (double)thisRoom.occupiedHoursNumber / (double) maxH);

        thisRealization.fitnessFunction = fitnessFuntionValue;
        //System.out.println("Fitness: " + thisRealization.fitnessFunction);
